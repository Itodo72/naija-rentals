...
module.exports = async function(req, res) {
  ...
  if (req.method === 'POST') {
    ...
    try {
      var listing = await prisma.listing.findUnique({ where: { id: listingId }, include: { landlord: true } })
      ...
      var psRes = await axios.post('https://api.paystack.co/transaction/initialize', psData, {
      ...
      return ok(res, { authorizationUrl: psRes.data.data.authorization_url, reference: ref, fees: fees }, 'Payment initialized')
    } catch (e) {
